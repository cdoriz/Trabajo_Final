...
write_csv(bondadaj_base, here("output", "table", "04_bondad_ajuste_modelo_base.csv"))
...
write_csv(bondadaj_completo, here("output", "table", "04_bondad_ajuste_modelo_completo.csv"))
